...
export default function Hero() {
  ...
  const searchHotels = () => {
    ...
    navigate(
      `/hotels?search=${destination}&checkIn=${checkIn}&checkOut=${checkOut}&guests=${guests}`
    );
  };
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          >
            ...
            <div className="flex flex-wrap gap-5 mt-10">
              ...
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full font-semibold shadow-xl">
                Explore Now
              </button>

              <button className="border border-white text-white px-8 py-4 rounded-full hover:bg-white hover:text-black">
                Learn More
              </button>
            ...
            <div className="w-full max-w-md rounded-3xl border border-white/20 bg-white/15 backdrop-blur-xl shadow-2xl p-8">
              ...
              <div className="space-y-5">
                ...
                <button
                  ...
                  className="w-full h-14 rounded-2xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-lg transition"
                >
                  Search Hotels
                </button>
